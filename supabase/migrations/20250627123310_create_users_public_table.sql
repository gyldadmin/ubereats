-- Migration: Create users_public table
-- Created: 2025-01-27 12:33:10
-- Description: Public user profile information that can be read by anyone
...
GRANT SELECT ON users_public TO anon; -- Allow anonymous users to read (public access) 